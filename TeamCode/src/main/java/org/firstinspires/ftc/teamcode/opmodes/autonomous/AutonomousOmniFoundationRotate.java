...
@Autonomous(name = "RotateFoundation", group = "SMHSBots")
public class AutonomousOmniFoundationRotate extends AutonomousOpMode {
    ...
    public void rotateFoundationRed() {
        ...
        //drag back to area
        pidDriveWithEncoders(35 * ticksPerInch, power);
